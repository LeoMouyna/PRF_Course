...
# plot the data from the log file along with the theoretical curve
 plot "< awk '$2 == 1 {print}' trace.log" u 1:6 t "cdr 1" w l  lc rgb "#AAAAAA",\
 "< awk '$2 == 2 {print}' trace.log" u 1:6 t "cdr 2" w l  lc rgb "#FFFFFF",